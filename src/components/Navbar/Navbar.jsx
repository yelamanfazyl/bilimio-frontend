...
const Navbar = () => {
  ...
  return (
    <div className="flex flex-row justify-between items-center w-full m-auto shadow-sm bg-[#282828] h-[15%] lg:h-[10%]">
      <div className="flex flex-row justify-between items-center w-[80%] m-auto h-[8vh] py-4">
        ...
        <div className="visible flex flex-row w-[55%] justify-between items-center gap-2">
          <div className={`flex flex-col lg:flex-row justify-between w-[65%] gap-2`}>
            <Link to="/problems">
          ...
          {isAuthState ? (
            ...
            <div className={`flex flex-col lg:flex-row justify-between w-[30%]`}>
              <Link to="/login">
                <p className="text-[16px] text-white">Войти</p>
              </Link>
              <div className="invisible lg:visible text-white">|</div>
